...
0000000000000358 <.note.gnu.build-id>:
 ...
 367:	00 9a 06 d9 f7 9a    	add    %bl,-0x650826fa(%rdx)
 36d:	65 67 d2 b3 37 c0 44 	shlb   %cl,%gs:-0x34bb3fc9(%ebx)
 374:	cb 
 375:	0f 1a fd             	nop    %ebp
 378:	8a 40 ef             	mov    -0x11(%rax),%al
 37b:	36                   	ss
...
0000000000002004 <__GNU_EH_FRAME_HDR>:
    ...
    201a:	ff                   	(bad)  
    201b:	ff 94 00 00 00 3c f0 	callq  *-0xfc40000(%rax,%rax,1)
    2022:	ff                   	(bad)  
    2023:	ff 54 00 00          	callq  *0x0(%rax,%rax,1)
...
0000000000002040 <__FRAME_END__-0xec>:
    ...
    20cf:	00 44 00 00          	add    %al,0x0(%rax,%rax,1)
    20d3:	00 94 00 00 00 68 f0 	add    %dl,-0xf980000(%rax,%rax,1)
    20da:	ff                   	(bad)  
    20db:	ff 65 00             	jmpq   *0x0(%rbp)
...
0000000000000000 <.debug_info>:
   0:	4f 00 00             	rex.WRXB add %r8b,(%r8)
  ...
  10:	0c 8d                	or     $0x8d,%al
  12:	00 00                	add    %al,(%rax)
  14:	00 94 00 00 00 29 11 	add    %dl,0x11290000(%rax,%rax,1)
  1b:	00 00                	add    %al,(%rax)
  1d:	00 00                	add    %al,(%rax)
  1f:	00 00                	add    %al,(%rax)
  21:	0a 00                	or     (%rax),%al
	...
  2b:	00 00                	add    %al,(%rax)
  2d:	02 ab 00 00 00 01    	add    0x1000000(%rbx),%ch
  33:	01 01                	add    %eax,(%rcx)
  35:	4b 00 00             	rex.WXB add %al,(%r8)
  38:	00 29                	add    %ch,(%rcx)
  3a:	11 00                	adc    %eax,(%rax)
  3c:	00 00                	add    %al,(%rax)
  3e:	00 00                	add    %al,(%rax)
  40:	00 0a                	add    %cl,(%rdx)
  42:	00 00                	add    %al,(%rax)
  ...
  48:	00 01                	add    %al,(%rcx)
  4a:	9c                   	pushfq 
  4b:	03 04 05 69 6e 74 00 	add    0x746e69(,%rax,1),%eax
	...
...
0000000000000000 <.debug_abbrev>:
  ...
  25:	07                   	(bad)  
  26:	40 18 97 42 19 00 00 	sbb    %dl,0x1942(%rdi)
  2d:	03 24 00             	add    (%rax,%rax,1),%esp
  30:	0b 0b                	or     (%rbx),%ecx
  32:	3e 0b 03             	or     %ds:(%rbx),%eax
  35:	08 00                	or     %al,(%rax)
	...
...
0000000000000000 <.debug_line>:
   0:	3d 00 00 00 03       	cmp    $0x3000000,%eax
   5:	00 1d 00 00 00 01    	add    %bl,0x1000000(%rip)        # 100000b <_end+0xffbff3>
   b:	01 fb                	add    %edi,%ebx
   d:	0e                   	(bad)  
  ...
  19:	00 01                	add    %al,(%rcx)
  1b:	00 6c 6f 6f          	add    %ch,0x6f(%rdi,%rbp,2)
  1f:	70 2e                	jo     4f <_init-0xfb1>
  21:	63 00                	movslq (%rax),%eax
  23:	00 00                	add    %al,(%rax)
  25:	00 00                	add    %al,(%rax)
  27:	05 01 00 09 02       	add    $0x2090001,%eax
  2c:	29 11                	sub    %edx,(%rcx)
  2e:	00 00                	add    %al,(%rax)
  30:	00 00                	add    %al,(%rax)
  32:	00 00                	add    %al,(%rax)
  34:	13 05 0a 00 02 04    	adc    0x402000a(%rip),%eax        # 4020044 <_end+0x401c02c>
  3a:	01 83 02 02 00 01    	add    %eax,0x1000202(%rbx)
  40:	01                   	.byte 0x1
...
0000000000000000 <.debug_str>:
  ...
  2c:	67 20 2d 66 61 73 79 	and    %ch,0x79736166(%eip)        # 79736199 <_end+0x79732181>
  33:	6e                   	outsb  %ds:(%rsi),(%dx)
  34:	63 68 72             	movslq 0x72(%rax),%ebp
  37:	6f                   	outsl  %ds:(%rsi),(%dx)
  38:	6e                   	outsb  %ds:(%rsi),(%dx)
  39:	6f                   	outsl  %ds:(%rsi),(%dx)
  3a:	75 73                	jne    af <_init-0xf51>
  3c:	2d 75 6e 77 69       	sub    $0x69776e75,%eax
  41:	6e                   	outsb  %ds:(%rsi),(%dx)
  42:	64 2d 74 61 62 6c    	fs sub $0x6c626174,%eax
  48:	65 73 20             	gs jae 6b <_init-0xf95>
  4b:	2d 66 73 74 61       	sub    $0x61747366,%eax
  50:	63 6b 2d             	movslq 0x2d(%rbx),%ebp
  53:	70 72                	jo     c7 <_init-0xf39>
  55:	6f                   	outsl  %ds:(%rsi),(%dx)
  56:	74 65                	je     bd <_init-0xf43>
  58:	63 74 6f 72          	movslq 0x72(%rdi,%rbp,2),%esi
  5c:	2d 73 74 72 6f       	sub    $0x6f727473,%eax
  61:	6e                   	outsb  %ds:(%rsi),(%dx)
  62:	67 20 2d 66 73 74 61 	and    %ch,0x61747366(%eip)        # 617473cf <_end+0x617433b7>
  69:	63 6b 2d             	movslq 0x2d(%rbx),%ebp
  6c:	63 6c 61 73          	movslq 0x73(%rcx,%riz,2),%ebp
  70:	68 2d 70 72 6f       	pushq  $0x6f72702d
  75:	74 65                	je     dc <_init-0xf24>
  77:	63 74 69 6f          	movslq 0x6f(%rcx,%rbp,2),%esi
  7b:	6e                   	outsb  %ds:(%rsi),(%dx)
  7c:	20 2d 66 63 66 2d    	and    %ch,0x2d666366(%rip)        # 2d6663e8 <_end+0x2d6623d0>
  82:	70 72                	jo     f6 <_init-0xf0a>
  84:	6f                   	outsl  %ds:(%rsi),(%dx)
  85:	74 65                	je     ec <_init-0xf14>
  87:	63 74 69 6f          	movslq 0x6f(%rcx,%rbp,2),%esi
  8b:	6e                   	outsb  %ds:(%rsi),(%dx)
  8c:	00 6c 6f 6f          	add    %ch,0x6f(%rdi,%rbp,2)
  90:	70 2e                	jo     c0 <_init-0xf40>
  92:	63 00                	movslq (%rax),%eax
  94:	2f                   	(bad)  
  95:	68 6f 6d 65 2f       	pushq  $0x2f656d6f
  9a:	68 61 72 73 68       	pushq  $0x68737261
  9f:	61                   	(bad)  
  a0:	2f                   	(bad)  
  a1:	6c                   	insb   (%dx),%es:(%rdi)
  a2:	65 63 74 75 72       	movslq %gs:0x72(%rbp,%rsi,2),%esi
  a7:	65 20 32             	and    %dh,%gs:(%rdx)
  aa:	00 6d 61             	add    %ch,0x61(%rbp)
  ad:	69                   	.byte 0x69
